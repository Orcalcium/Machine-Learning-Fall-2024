...
for i in range(1126):  # Run with different random seeds
    ...
    non_zero_components_list.append(np.count_nonzero(best_W))
...
# Plot histogram of non-zero components for the best lambda
plt.hist(non_zero_components_list, bins=30, edgecolor='black')
plt.title('Histogram of Non-zero Components of g')
